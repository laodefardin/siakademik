...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Edit Pelajaran | Si Akademik</title>
          ...
          <div class="page-wrapper" style="padding:1rem">
            ...
            <div class="card total-request-card">
              <div class="card-header">
                ...
                <span>Halaman ini untuk mengedit data pelajaran</span>
              </div>
               ...
               ?>
                  ...
                  <form class="form-horizontal style-form" action="update-pelajaran.php" method="post" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="kode_pelajaran" type="text" id="kode_pelajaran" class="form-control" value="<?php echo $data['kode_pelajaran'];?>" autofocus="on" />
                              </div>
                          </div>
                          <div class="form-group">
