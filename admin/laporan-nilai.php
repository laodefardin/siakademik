            ...
            <div class="card total-request-card">
              <div class="card-block">
                <div class="row" style="margin-bottom:20px">
                  ...
                  <a href="laporan-nilai" class="btn btn-sm btn-warning"> Refresh </a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-hover table-striped">
                <tr>
                  ...
                  <th style="min-width:80px;white-space: inherit">Jurusan </th>
                ...
                while ($myData = mysql_fetch_array($myQry)) {
                  ...
                  <tr>
                    ...
                    <td style="min-width:80px;white-space: inherit"> <?php echo $myData['jurusan']; ?> </td>
                    ...
                    <td><center><a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-original-title="Print Nilai" href="cetak-nilai.php?hal=edit-admin&kd=<?php echo $Kode;?>"><span class="icofont-print"></span></a></td>
                    </tr>
                    <?php   
                  } 
                  ?>
