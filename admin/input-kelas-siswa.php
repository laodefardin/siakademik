...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Input Kelas Siswa | Si Akademik</title>
          ...
          <div class="page-wrapper" style="padding:1rem">
            ...
            <div class="card total-request-card">
              <div class="card-header">
                ...
                <span>Halaman ini untuk menginput/menambah Kelas siswa</span>
              </div>

              <div class="card-block">


                <form class="form-horizontal style-form" action="insert-kelas-siswa.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <option> ---- Pilih Salah Satu ---- </option>
                      <?php
                      $sql = mysql_query("SELECT * FROM siswa ORDER BY kode_siswa ASC");
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Nama Jurusan</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <a href="input-kelas-siswa.php" class="btn btn-sm btn-danger">Batal </a>
                  </div>
                </div>
              </form>
