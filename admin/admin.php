...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Data Admin | Si Akademik</title>
                  ...
                  <div class="col-xs-12 col-sm-6">
                    <div class="row">
                      <div class="col-xs-12 col-md-10">
                        ...
                        <a href='admin' class="btn btn-sm btn-success" >Refresh</i></a>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="card">
            ...
            <div class="card-block table-border-style">
              <div class="button-panel" style="padding: 0px 20px 10px 20px;float:left">
                <a class="btn btn-primary btn-bordered btn-mini pull-right" href="input-admin">
                ...
                <div class="table-responsive">
                 ...
                 <table class="table table-hover table-striped">
                  ...
                  { ?>
                    <tr>
                      <td style="min-width:80px;white-space: inherit"><?php echo $data['user_id']; ?></td>
                      ...
                      <td style="min-width:80px;white-space: inherit"><?php echo $data['fullname']; ?></td>
                      <td style="min-width:80px;white-space: inherit"><img src="<?php echo $data['gambar']; ?>" class="img-circle" width="60" style="border: 3px solid orange;" /></td>
                      <td><center><a class="btn btn-sm btn-primary tooltips" data-placement="bottom" data-original-title="Edit Admin" href="edit-admin.php?hal=edit-admin&kd=<?php echo $data['user_id'];?>"><span class="icofont-edit"></span></a>
                        <hr /> <a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Admin" href="hapus-admin.php?hal=hapus&kd=<?php echo $data['user_id'];?>"><span class="icofont-trash"></a></center></td></tr>
                         <?php   
                       } 
                       ?>
                     </tbody>
