...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Laporan Kelas | Si Akademik</title>
                  ...
                  <div class="col-xs-12 col-sm-6">
                    <div class="row">
                      <div class="col-xs-12 col-md-10">
                        ...
                        <a href='laporan-kelas' class="btn btn-sm btn-success">Refresh</i></a>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="card">
            ...
            <div class="card-block table-border-style">
              <div class="button-panel" style="padding: 0px 20px 10px 20px;float:left">
                <a class="btn btn-primary btn-bordered btn-mini pull-right" href="kelas_pdf">
                ...
                <div class="table-responsive">
                 ...
                 <tr>
                  ...
                  <th style="min-width:80px;white-space: inherit">Tahun Ajaran <i class="icofont-sort"></i></th>
                  ...
                  <th style="min-width:80px;white-space: inherit">Wali Kelas <i class="icofont-sort"></i></th>
                  <th style="min-width:80px;white-space: inherit">Status <i class="icofont-sort"></i></th>
                </tr>
