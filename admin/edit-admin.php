...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Edit Admin | Si Akademik</title>
          ...
          <div class="page-wrapper" style="padding:1rem">
            ...
            <div class="card total-request-card">
              <div class="card-header">
                ...
                <span>Halaman ini untuk mengedit data admin</span>
              </div>

              <div class="card-block">

               <?php
               $query = mysql_query("SELECT * FROM user WHERE user_id='$_GET[kd]'");
               ...
               <form class="form-horizontal style-form" action="update-admin.php" method="post" name="form1" id="form1">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <img src="<?php echo $data['gambar'];?>" class="img-circle" style="border: 3px solid orange;"/>
                  </div>
                </div>
                <div class="form-group">
