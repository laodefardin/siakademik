...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Laporan Pelajaran | Si Akademik</title>
  ...
  <div class="pcoded-wrapper">
    ...
    <div class="pcoded-content">
      <div class="pcoded-inner-content">
        <div class="main-body">
          <form action='laporan-pelajaran.php' method="POST">
                  ...
                  <div class="col-xs-12 col-sm-6">
                    <div class="row">
                      <div class="col-xs-12 col-md-10">
                        ...
                        <a href='laporan-pelajaran' class="btn btn-sm btn-success" >Refresh</i></a>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h5>Laporan Pelajaran</h5>
            </div>
            <div class="card-block table-border-style">
              <div class="button-panel" style="padding: 0px 20px 10px 20px;float:left">
                <a class="btn btn-primary btn-bordered btn-mini text-right" href="pelajaran_pdf.php">
                ...
                { ?>
                  <tr>
                    ...
                    <td style="min-width:80px;white-space: inherit"><?php echo $data['keterangan'];?></td></tr>
                    <?php   
                  } 
                  ?>
                </tbody>
