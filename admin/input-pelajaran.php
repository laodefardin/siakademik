...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Input Pelajaran | Si Akademik</title>
          ...
          <div class="page-wrapper" style="padding:1rem">
            ...
            <div class="card total-request-card">
              <div class="card-header">
                <h4>Input Pelajaran</h4>
                <span>Halaman ini untuk menginput/menambah Pelajaran</span>
              </div>
              ...
              <div class="card-block">
                ...
                <form class="form-horizontal style-form" action="insert-pelajaran.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="nama_pelajaran" type="text" id="nama_pelajaran" class="form-control" placeholder="Nama Pelajaran" required />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <a href="pelajaran" class="btn btn-sm btn-danger">Batal </a>
                  </div>
                </div>
              </form>
