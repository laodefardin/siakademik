                  ...
                  <div class="col-xs-12 col-sm-6">
                    <div class="row">
                      <div class="col-xs-12 col-md-10">
                        ...
                        <a href='siswa' class="btn btn-sm btn-success" >Refresh</i></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="button-panel" style="padding: 0px 20px 10px 20px;float:left">
                ...
                { ?>
                  <tr>
                    ...
                    <td><img src="<?php echo $data['gambar']; ?>" width="60" height="60" class="img-circle" style="border: 3px solid orange;" /></td>
                    <td><center><a class="btn btn-mini btn-primary tooltips" data-placement="bottom" data-original-title="Edit Siswa" href="edit-siswa?hal=edit-admin&kd=<?php echo $data['kode_siswa'];?>"><span class="icofont-edit"></span></a>
                      <hr /><a class="btn btn-mini btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Siswa" href="hapus-siswa.php?hal=hapus&kd=<?php echo $data['kode_siswa'];?>"><span class="icofont-trash"></a></center></td></tr>
                       <?php   
                     } 
                     ?>
                   </tbody>
