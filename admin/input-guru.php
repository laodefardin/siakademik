...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Input Data Guru | Si Akademik</title>
          ...
          <div class="page-wrapper" style="padding:1rem">
            ...
            <div class="card total-request-card">
              <div class="card-header">
                ...
                <span>Halaman ini untuk menginput/menambah data guru</span>
              </div>

              <div class="card-block">


                <form class="form-horizontal style-form" action="insert-guru.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="nip" type="text" id="nip" class="form-control" placeholder="Nomor Induk Pegawai" required />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="nama_guru" type="text" id="nama_guru" class="form-control" placeholder="Nama Guru" required />
                    </div>
                  </div>
                  <div class="form-group">
