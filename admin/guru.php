                  ...
                  <div class="col-xs-12 col-sm-6">
                    <div class="row">
                      <div class="col-xs-12 col-md-10">
                        ...
                        <a href='guru' class="btn btn-sm btn-success" >Refresh</i></a>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="card">
            ...
            <div class="card-block table-border-style">
              <div class="button-panel" style="padding: 0px 20px 10px 20px;float:left">
                <a class="btn btn-primary btn-bordered btn-mini pull-right" href="input-guru">
                ...
                { ?>
                  <tr>
                    ...
                    <td><center><a class="btn btn-mini btn-primary tooltips" data-placement="bottom" data-original-title="Edit Guru" href="edit-guru.php?hal=edit-admin&kd=<?php echo $data['kode_guru'];?>"><span class="icofont-edit"></span></a>
                      <hr /><a class="btn btn-mini btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Guru" href="hapus-guru.php?hal=hapus&kd=<?php echo $data['kode_guru'];?>"><span class="icofont-trash"></a></center></td></tr>
                       <?php   
                     } 
                     ?>
                   </tbody>
