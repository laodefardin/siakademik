...
<html lang="en">
<head>
    <title>Login Siswa | Si Akademik</title>
...
<!--[if lt IE 10]>
  ...
  <link rel="icon" href="https://cekmutasi.co.id/assets/images/favicon.ico" type="image/x-icon">
...
<body class="fix-menu">
    ...
    <section id="home" class="hero_section gradiant_1 padding">
        <div class="login-card card-block auth-body mr-auto ml-auto">
            <form class="md-float-material" action="proseslogin-siswa.php" method="POST">
                <div class="auth-box">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                            <h1 style="font-family: 'Montserrat', sans-serif; font-weight: 800; letter-spacing: -0.05em; margin-bottom: -1px;">Si Akademik</h1>
                                <h4 style="font-family: 'Montserrat', sans-serif; font-weight: 500; letter-spacing: -0.05em;">Sistem Informasi Akademik SMK Negeri 5 Gowa</h4>
                                <h5 style="font-family: 'Montserrat', sans-serif; font-weight: 800; letter-spacing: -0.05em;">LOGIN SISWA</h5>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addon1"><i class="icofont icofont-ui-user"></i></span>
                        <input type="input" id="username" name="username" class="form-control" placeholder="Masukan NIS (Nomor Induk Siswa)" required autofocus>
                        <span class="md-line"></span>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addon1"><i class="icofont icofont-ui-lock"></i></span>
                        <input type="password" id="password" name="password" class="form-control" placeholder="Kata sandi Anda" required autofocus>
                        <span class="md-line"></span>
                    </div>
                    <div class="row m-t-30">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-danger btn-md btn-block waves-effect text-center m-b-20">Masuk</button>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                         <p class="text-inverse text-center m-b-0">atau login sebagai</p>

                         <center>
                            <a class="btn btn-primary btn-bordered btn-sm" href="index">
                            <i class="icofont-ui-user"></i>Admin</a>
                            <a class="btn btn-warning btn-bordered btn-sm" href="login-guru">
                               <i class="icofont-ui-user"></i>Guru</a>
                            </center>
                        </div>
                    </div>
                </div>
        ...
        </div><div id="particles-js" class="particles-js"><canvas class="particles-js-canvas-el" style="width: 100%; height: 100%;" width="1349" height="670"></canvas></div>
