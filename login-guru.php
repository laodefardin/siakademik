...
<html lang="en">
<head>
    <title>Login Guru | Si Akademik</title>
...
<body class="fix-menu">
    ...
    <section id="home" class="hero_section gradiant_3 padding">
        <div class="login-card card-block auth-body mr-auto ml-auto">
            <form class="md-float-material" action="proseslogin-guru.php" method="POST">
                <div class="auth-box">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                ...
                                <h5 style="font-family: 'Montserrat', sans-serif; font-weight: 800; letter-spacing: -0.05em;">LOGIN GURU</h5>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="input-group">
                        ...
                        <input type="input" id="username" name="username" class="form-control" placeholder="Username Anda" required="">
                        <span class="md-line"></span>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addon1"><i class="icofont icofont-ui-lock"></i></span>
                        <input type="password" id="password" name="password" class="form-control" placeholder="Kata sandi Anda" required="">
                        <span class="md-line"></span>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                         ...
                         <center>
                            ...
                            <a class="btn btn-danger btn-bordered btn-sm" href="login-siswa">
                                <i class="icofont-ui-user"></i>Siswa</a>
                            </center>
                        </div>
                    </div>
                </div>
