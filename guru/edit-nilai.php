          ...
          <div class="page-wrapper" style="padding:1rem">
            ...
            <div class="card total-request-card">
              ...
              <div class="card-block">
                ...
                <?php
                $query = mysql_query("SELECT nilai.*, pelajaran.nama_pelajaran, siswa.nama_siswa, siswa.nis, guru.nama_guru, kelas.nama_kelas FROM nilai
                LEFT JOIN pelajaran ON nilai.kode_pelajaran = pelajaran.kode_pelajaran
                LEFT JOIN siswa ON nilai.kode_siswa = siswa.kode_siswa LEFT JOIN guru ON nilai.kode_guru = guru.kode_guru LEFT JOIN kelas ON nilai.kode_kelas = kelas.kode_kelas WHERE id='$_GET[kd]'");
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <select name="kode_pelajaran" id="kode_pelajaran"  class="form-control" readonly="readonly" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <select name="kode_guru" id="kode_guru"  class="form-control" readonly="readonly" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <select name="kode_kelas" id="kode_kelas"  class="form-control" readonly="readonly" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <select name="kode_siswa" id="kode_siswa"  class="form-control" readonly="readonly" />
