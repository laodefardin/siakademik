            ...
            <div class="button-panel" style="padding: 0px 20px 10px 20px;float:left">
              ...
              <div class="table-responsive">
                ...
                <tr>
                  ...
                  <th style="min-width:80px;white-space: inherit">Pelajaran </th>
                ...
                <?php
                $myQry = mysql_query("SELECT nilai.*, pelajaran.nama_pelajaran, siswa.nama_siswa, siswa.nis, guru.nama_guru FROM nilai
                  LEFT JOIN pelajaran ON nilai.kode_pelajaran = pelajaran.kode_pelajaran
                  LEFT JOIN siswa ON nilai.kode_siswa = siswa.kode_siswa LEFT JOIN guru ON nilai.kode_guru = guru.kode_guru
                ...
                while ($myData = mysql_fetch_array($myQry)) {
                  ...
                  <tr>
                    ...
                    <td style="min-width:80px;white-space: inherit"><?php echo $myData['nama_guru']; ?></td>
                    ...
                    <td style="min-width:80px;white-space: inherit"><?php echo $myData['nama_pelajaran']; ?></td>
